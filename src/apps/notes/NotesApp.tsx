      ...
      <div className="bg-white w-[100%] rounded-md">
        <div className="space-y-6">
          ...
          <div className="relative overflow-hidden rounded-xl">
            <div className="bg-gradient-to-r from-indigo-500/90 to-indigo-600/90 h-48 flex items-center justify-center">
        ...
        <div className="w-[100%] max-w-[600px] my-2 rounded-md bg-slate-200 p-6">
          <div className="text-center py-12">
            ...
            <p className="text-slate-600">
              Rich text editor with search, categories, and organization
              features.
            </p>
          </div>
        </div>
        <div className="h-[64vh] flex items-center justify-center bg-slate-100 w-[100%]">
          <p className="text-slate-500">Notes editor will be displayed here.</p>
        </div>
      </div>
    </section>
  );
